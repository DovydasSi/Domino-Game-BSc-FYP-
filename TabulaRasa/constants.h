...
#define MAX_PROC_NUM         (8) // Number of players
#define NUM_OF_CYCLES        (5) // Deprecated
#define DROP_ALTER_CHANCE    (2)
#define TILES_IN_HAND        (3)

// Normal Dominos go from 0 to 6 
// but we might want to change that 
#define MIN_TILE_NUM         (0)
#define MAX_TILE_NUM         (10)
